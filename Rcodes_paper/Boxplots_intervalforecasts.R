#This R code produces the plots of the Figure 3. For the computations of interval 
#coverages based on  FMP-ANOVA approach

library(ggplot2)
library(tidyverse)

us.base <- readRDS("./results_for the plots/USA/Emp_cov_USA.rds")
france.base <- readRDS("./results_for the plots/France/Emp_cov_France.rds")
japan.base <- readRDS("./results_for the plots/Japan/Emp_cov_Japan.rds")
